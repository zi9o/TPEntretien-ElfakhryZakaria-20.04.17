...
var appPhaino = angular.module('phainoUserApp',
  ['phainoUserApp.config', 'ui.router', 'angularUtils.directives.dirPagination',
    ...
    'ngFileUpload', 'angularMoment', 'angular-loading-bar', 'angular-ladda']);
 ...
 */
angular.module('phainoUserApp')
  .config(['$stateProvider', '$urlRouterProvider', '$locationProvider', '$authProvider', 'GENERAL_CONFIG'
    , function ($stateProvider, $urlRouterProvider, $locationProvider, $authProvider, GENERAL_CONFIG) {
